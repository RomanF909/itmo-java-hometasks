...
public class Task02 {
    ...
    public  static  List<String> getLogins(HashMap<String, String> map, String city) {
        ...
        for (Map.Entry<String, String> pair : map.entrySet()) {
            if (pair.getValue().contains(city)) {
    ...
    public Map<List<String>, Integer> getWords(){
        HashMap<List<String>, Integer> taskWord = new HashMap<>();
       int a = 0;
        for (List<String> strings : taskWord.keySet()) {
            if (taskWord.containsKey(strings)){
                taskWord.put(strings, a++);
            }
        }
        return taskWord;
