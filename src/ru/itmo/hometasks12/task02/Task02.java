package ru.itmo.hometasks12.task02;
...
public class Task02 {
    public static void main(String[] args) {
        ...
        Map<String, Long> map01 = account1.stream()
                .collect(Collectors.groupingBy(transaction -> transaction.length);

       long sum = transactionStream.mapToLong(tr -> tr.getSum()).sum(); // R apply(T t)
     ...
     /*   long sum = transactionStream.reduce(
                ...
                (i1, i2) -> i1 + i2 //Integer::sum // BinaryOperator<U> combiner R apply(U t, U u);
        );
*/
