...
public class Task5 {
    public static void main(String[] args) {
               ...
               // латинских букв строчных и заглавных, цифр, а также символов «$» и «_». По соглашению $ не используют
...
// var присываивает тип данных переменной автоматически на основании значения
                // 6. Сколько байт занимает в памяти переменная типа long?

                // 8 байт
                // 7. Что такое явное приведение типов?

                // объявление конкретного типа к которому мы хотим привести значение
               ...
               // как и то, и другое true
                // 11. Что такое тело цикла?
              //  после оператора {}, код внутри цикла
                // 12. Что такое итерация цикла?

                //1 раз проверка всех условий цикла
                ...
                // так правильно код:
               // if (age >= 18) System.out.println("Вы можете просматривать товары и совершать покупки"); // если 18
              // else System.out.println("Вы можете просматривать товары, но не совершать покупки"); // если 14


                // 15. Для чего программам нужен метод main?
              //  с него начинается выполнение программы
                ...
                // тип данных примитивный, зависит от введенного значения
